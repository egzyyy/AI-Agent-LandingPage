      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <span className={`font-bold text-base tracking-tight transition-colors ${scrolled ? 'text-black' : 'text-white'}`} style={font}>
              Ember <span className="text-rose-400">Table</span>
            </span>
          </div>
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 w-full">
          <Reveal>
            ...
            <h1 className="text-6xl md:text-8xl font-black text-white leading-none tracking-tighter mb-6" style={font}>
              Great Food,<br />
              <em className="text-rose-400 not-italic">Every Time.</em>
            </h1>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {mvv.map((item, i) => (
              <Reveal key={i} delay={i * 0.1}>
                <div className="bg-white rounded-3xl p-10 border border-neutral-100 hover:border-rose-200 transition-all hover:shadow-lg">
            ...
            <div className="w-full lg:w-5/12 lg:sticky lg:top-24">
              <Reveal direction="right">
                ...
                <p className="text-neutral-500 mb-8 leading-relaxed text-sm">
                  From intimate lunches to grand celebrations — every meal crafted with the same care and attention to detail.
                </p>
                <img
                  src="https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&w=800&q=80"
                  alt="Ember Table dishes"
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-16">
          <Reveal direction="right">
            ...
            <div className="space-y-7">
              {[
                { icon: <MapPin size={18} />, label: 'Address', value: 'Lot 5, Menara KLCC, Jalan Ampang, 50450 Kuala Lumpur' },
                { icon: <Phone size={18} />, label: 'Phone', value: '+60 3-2382 8899' },
                { icon: <Mail size={18} />, label: 'Email', value: 'hello@ember-table.com.my' },
                { icon: <Clock size={18} />, label: 'Hours', value: 'Mon–Fri 11am–10pm · Sat–Sun 10am–11pm' },
              ].map((item, i) => (
            ...
            <div className="bg-neutral-50 rounded-3xl p-8 md:p-10 border border-neutral-100">
              ...
              <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-neutral-500 uppercase tracking-wider mb-2">Package</label>
                    <select defaultValue=""
                ...
                <div>
                  ...
                  <textarea rows={3} placeholder="Preferred date, party size, or special requests..."
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 pb-12 border-b border-neutral-800">
            <div className="md:col-span-2">
              <div className="flex items-center gap-2.5 mb-4">
                ...
                <span className="text-white font-bold" style={font}>Ember Table</span>
              </div>
              <p className="text-sm leading-relaxed max-w-xs mb-6">
                KL's most beloved dining destination — honest food, warm hospitality, and memories worth making.
              </p>
              <div className="flex gap-3">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li className="flex justify-between"><span>Sunday</span><span className="text-neutral-300">10am – 11pm</span></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li className="flex items-start gap-2">
                  ...
                  <span>Lot 5, Menara KLCC, Jalan Ampang, 50450 KL</span>
                </li>
                <li className="flex items-center gap-2">
                  <Phone size={13} className="text-rose-500 shrink-0" />
                  <span>+60 3-2382 8899</span>
                </li>
                <li className="flex items-center gap-2">
