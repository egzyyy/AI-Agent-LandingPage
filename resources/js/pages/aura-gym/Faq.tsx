...
const faqItems = [
  {
    ...
    a: 'No joining fee for the first month — just your monthly membership.',
  },
  {
    q: 'Can I freeze my membership?',
    a: 'Members can freeze up to 2 months per year with 7 days notice.',
  },
  {
    q: 'Do you offer a free trial?',
    a: 'Yes — first 3 days free for new members. No credit card required.',
  },
];
